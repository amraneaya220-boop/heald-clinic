    ...
    <div class="main-content">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul>
                ...
                <li><a href="{{ route('clinic.doctors.index') }}" id="menuDoctors">👨‍⚕️ Manage Doctors</a></li>
                <li><a href="{{ route('clinic.patients.index') }}" id="menuPatients">👥 Manage Patients</a></li>
                <li><a href="{{ route('clinic.appointments.index') }}" id="menuAppointments">📅 Manage Appointments</a></li>
                <li><a href="{{ route('clinic.invoices.index') }}" id="menuInvoices">📄 Patient Invoices</a></li>
                <li><a href="{{ route('clinic.statistics.index') }}" id="menuStats">📈 Statistics</a></li>
                <li><a href="{{ route('clinic.reports.index') }}" id="menuReports">📋 Reports</a></li>
                <li><a href="{{ route('clinic.announcements.index') }}" id="menuReports"> Ad</a></li>
                <li><a href="{{ route('clinic.settings.index') }}" id="menuSettings">⚙️ System Settings</a></li>
            </ul>
        </div>
        ...
        <div class="header">
            ...
            <div class="notification-area">
                <div class="bell-icon" onclick="window.location.href='{{ route('clinic.notifications.index') }}'">
...
<script>
    ...
    async function fetchStats() {
        try {
            const res = await fetch('{{ route("clinic.dashboard.stats") }}');
    ...
    async function fetchRecentAppointments() {
        try {
            const res = await fetch('{{ route("clinic.dashboard.recent") }}');
            const data = await res.json();
    ...
    async function fetchReviews() {
        try {
            const res = await fetch('{{ route("clinic.dashboard.reviews") }}');
            const data = await res.json();
            if (data.success) {
