{{-- resources/views/clinic/settings/index.blade.php --}}
...
<script>
    ...
    async function loadSettings() {
        try {
            const response = await fetch('{{ route("clinic.settings.data") }}');
    ...
    async function updateClinicInfo() {
        ...
        try {
            const response = await fetch('{{ route("clinic.settings.clinic.update") }}', {
                method: 'POST',
                headers: {
    ...
    async function updatePrices() {
        ...
        try {
            const response = await fetch('{{ route("clinic.settings.prices.update") }}', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken
    ...
    async function addCustomService() {
        ...
        try {
            const response = await fetch('{{ route("clinic.settings.services.store") }}', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken
    ...
    async function deleteService(id) {
        if (confirm('Are you sure you want to delete this service?')) {
            try {
                const response = await fetch(`{{ url('clinic/settings/services') }}/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': csrfToken,
                        'Content-Type': 'application/json'
    ...
    async function addSchedule() {
        ...
        try {
            const response = await fetch('{{ route("clinic.settings.schedules.store") }}', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken
    ...
    async function deleteSchedule(id) {
        if (confirm('Are you sure you want to delete this schedule?')) {
            try {
                const response = await fetch(`{{ url('clinic/settings/schedules') }}/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': csrfToken,
                        'Content-Type': 'application/json'
    ...
    async function addSpecialty() {
        ...
        try {
            const response = await fetch('{{ route("clinic.settings.specialties.store") }}', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken
    ...
    async function deleteSpecialty(id) {
        if (confirm('Are you sure you want to delete this specialty?')) {
            try {
                const response = await fetch(`{{ url('clinic/settings/specialties') }}/${id}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': csrfToken,
                        'Content-Type': 'application/json'
    ...
    async function uploadClinicImage() {
        ...
        try {
            const response = await fetch('{{ route("clinic.settings.image.upload") }}', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': csrfToken
                },
