    ...
    <div class="login-card">
        <div class="login-body">
            <div class="type-selector">
                <button type="button" class="type-btn {{ ($type ?? 'patient') == 'clinic' ? 'active' : '' }}" data-type="clinic" onclick="selectType('clinic')">🏥 Clinic</button>
                <button type="button" class="type-btn {{ ($type ?? 'patient') == 'doctor' ? 'active' : '' }}" data-type="doctor" onclick="selectType('doctor')">👨‍⚕️ Doctor</button>
                <button type="button" class="type-btn {{ ($type ?? 'patient') == 'patient' ? 'active' : '' }}" data-type="patient" onclick="selectType('patient')">👤 Patient</button>
            </div>
            ...
            <form method="POST" action="{{ route('login.post') }}" id="loginForm">
                @csrf
                <input type="hidden" name="role" id="loginRole" value="{{ $type ?? 'patient' }}">
                ...
                @if(session('error'))
                    <div class="error-message-server">{{ session('error') }}</div>
                @endif
            ...
            <div class="register-link">
                ...
                <a id="registerLink" href="{{ route('register', ['type' => ($type ?? 'patient')]) }}">Create an Account</a>
            </div>
        </div>
    </div>
</div>
...
function updateRegisterLink(){
    ...
    if(registerLink){
        registerLink.href = "{{ url('/register') }}?type=" + currentType;
    }
}
