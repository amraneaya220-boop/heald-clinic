...
@section('title', 'MediEase - Find Best Clinics in Algeria')
...
<section class="hero" id="home">
    <div class="hero-content">
        <h1 id="title">@lang('Book Your Medical Appointment Easily')</h1>
        <p id="desc">@lang('Find the best clinics and doctors in Algeria')</p>
        <div class="search-container">
            <div class="search-box">
                <input type="text" id="searchInput" placeholder="@lang('Search for clinic or doctor...')" autocomplete="off">
                <button onclick="searchItem()" id="searchBtn"><i class="fas fa-search"></i> @lang('Search')</button>
            </div>
...
<div class="about-modern" id="about">
    <div class="container-modern">
        <div class="modern-title">
            <h2 id="aboutMainTitle">@lang('About MediEase')</h2>
            <p id="aboutMainDesc">@lang('Your comprehensive healthcare management platform in Algeria')</p>
        </div>
    ...
    <div class="reviews-container">
        ...
        <div class="review-form">
            <div class="rating-container">
                ...
                <div class="rating-text" id="ratingText">@lang('Click to rate')</div>
            </div>
            <textarea id="reviewFeedback" placeholder="@lang('Write your experience...')"></textarea>
            <button class="btn-submit" onclick="submitReview()"><i class="fas fa-paper-plane"></i> @lang('Send Feedback')</button>
        </div>
        <div class="reviews-list" id="reviewsList">
            <div class="no-reviews" id="noReviewsMsg">@lang('No reviews yet. Be the first to share your experience!')</div>
        </div>
    </div>
</div>
@endsection
...
<script>
    ...
    var clinicsData = {!! json_encode($clinics ?? [], JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) !!};
var doctorsData = {!! json_encode($doctors ?? [], JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) !!};
    var allItems = [];
