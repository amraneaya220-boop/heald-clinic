...
<?php $__env->startSection('title', $clinic->name . ' - Full Details'); ?>
...
<div class="container">
    <div class="details-card">
        <div class="clinic-gallery">
            <img src="<?php echo e($clinic->image); ?>" alt="<?php echo e($clinic->name); ?>" onerror="this.src='https://placehold.co/750x400/1e3a8a/white?text=<?php echo e(urlencode($clinic->name)); ?>'">
        </div>
        ...
        <div class="content">
            ...
            <div class="info-section">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo e($clinic->address); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-icon">📞</div>
                    <div class="info-label">Phone</div>
                    <div class="info-value"><?php echo e($clinic->phone); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-icon">📧</div>
                    <div class="info-label">Email</div>
                    <div class="info-value"><?php echo e($clinic->email ?? 'Not provided'); ?></div>
                </div>
                <?php if($clinic->map_link): ?>
                <div class="info-row">
                    <div class="info-icon">🗺️</div>
                    <div class="info-label">Google Maps</div>
                    <div class="info-value"><a href="<?php echo e($clinic->map_link); ?>" target="_blank" class="map-link">Open in Google Maps →</a></div>
                </div>
                <?php endif; ?>
                <?php if($clinic->nearby_landmark): ?>
                <div class="info-row">
                    <div class="info-icon">🕌</div>
                    <div class="info-label">Nearby</div>
                    <div class="info-value"><?php echo e($clinic->nearby_landmark); ?></div>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo e($clinic->working_hours ?? 'Contact clinic for hours'); ?></div>
                </div>
            </div>
            ...
            <!-- Price Range -->
            <?php if($clinic->price_range): ?>
            <div class="info-section">
                <h3>💰 Price Range</h3>
                <div class="info-row">
                    <div class="info-icon">💵</div>
                    <div class="info-label">Cost</div>
                    <div class="info-value"><span class="price-tag"><?php echo e($clinic->price_range); ?></span></div>
                </div>
            </div>
            <?php endif; ?>
            
            <!-- Available Services -->
            <?php if($clinic->services && count($clinic->services) > 0): ?>
            <div class="info-section">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <?php $__currentLoopData = $clinic->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="service-badge">✓ <?php echo e($service->name); ?></span>
            ...
            <button class="btn-view-doctors" onclick="goToDoctors()">
                👨‍⚕️ View All Doctors (<?php echo e($clinic->doctors->count()); ?>)
            </button>
...
let clinicId = <?php echo e($clinic->id); ?>;
...
function goBack() {
    window.location.href = "<?php echo e(route('clinics.index')); ?>";
}

function goToDoctors() {
    window.location.href = "<?php echo e(route('clinic.doctors', $clinic->id)); ?>";
}
...
function goToLogin() {
    window.location.href = "<?php echo e(route('login')); ?>?redirect=details&clinic_id=<?php echo e($clinic->id); ?>";
}
...
function bookClinicAppointment() {
    ...
    localStorage.setItem("appointmentClinicName", "<?php echo e($clinic->name); ?>");
    localStorage.setItem("appointmentClinicAddress", "<?php echo e($clinic->address); ?>");
    localStorage.setItem("appointmentClinicPhone", "<?php echo e($clinic->phone); ?>");
    localStorage.setItem("appointmentClinicId", "<?php echo e($clinic->id); ?>");
    
    window.location.href = "<?php echo e(route('appointments.create', ['clinic_id' => $clinic->id])); ?>";
}

// Load clinic statistics (average rating)
function loadClinicStats() {
    fetch('/api/clinics/<?php echo e($clinic->id); ?>/stats')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heald-clinic\resources\views/front/details.blade.php ENDPATH**/ ?>