...
<?php $__env->startSection('title', 'Medical Invoice | Smart Receipt'); ?>
        ...
        <div class="invoice-body">
            ...
            <div class="appointment-row">
                <div class="appointment-field">
                    <label>📆 DATE</label>
                    <input type="date" id="appointmentDate" value="<?php echo e(date('Y-m-d')); ?>">
                </div>
                <div class="appointment-field">
                    <label>⏰ TIME</label>
...
<script>
    ...
    async function fetchInvoiceNumber() {
        try {
            const response = await fetch('<?php echo e(route("clinic.invoices.generate-number")); ?>');
    ...
    async function saveInvoiceToDatabase() {
        ...
        try {
            const response = await fetch('<?php echo e(route("clinic.invoices.store")); ?>', {
                method: 'POST',
                headers: {
...
═══════════════════════════════════════════════════════════`;
    ...
    function resetAllFields() {
        ...
        document.getElementById("appointmentDate").value = "<?php echo e(date('Y-m-d')); ?>";
...
<?php echo $__env->make('clinic.layouts.clinic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heald-clinic\resources\views/clinic/invoices/index.blade.php ENDPATH**/ ?>