...
<?php $__env->startSection('title', $clinic->name . ' - Doctors'); ?>
...
<div class="container">
    <div class="header">
        <h1>👨‍⚕️ <?php echo e($clinic->name); ?> - Medical Team</h1>
        <p>Meet our expert doctors</p>
        <span class="count-badge"><?php echo e($doctors->count()); ?> Doctors</span>
    </div>
...
<script>
    var doctors = <?php echo json_encode($doctors, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heald-clinic\resources\views/front/doctors.blade.php ENDPATH**/ ?>