...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Patient Dashboard'); ?> - MediEase</title>
...
<div class="container">
    ...
    <div class="nav-links">
        <a href="<?php echo e(route('patient.index')); ?>" class="<?php echo e(request()->routeIs('patient.index') ? 'active' : ''); ?>">
            <i class="fas fa-home"></i> <span id="nav_home">Home</span>
        </a>
        <a href="<?php echo e(route('patient.diagnoses')); ?>" class="<?php echo e(request()->routeIs('patient.diagnoses') ? 'active' : ''); ?>">
            <i class="fas fa-stethoscope"></i> <span id="nav_diagnosis">Diagnoses</span>
        </a>
        <a href="<?php echo e(route('patient.invoices')); ?>" class="<?php echo e(request()->routeIs('patient.invoices') ? 'active' : ''); ?>">
            <i class="fas fa-file-invoice-dollar"></i> <span id="nav_invoices">Invoices</span>
        </a>
        <a href="<?php echo e(route('patient.profile')); ?>" class="<?php echo e(request()->routeIs('patient.profile') ? 'active' : ''); ?>">
...
<script>
    ...
    document.getElementById('profileAvatar').addEventListener('click', () => window.location.href = "<?php echo e(route('patient.profile')); ?>");
...
</html><?php /**PATH C:\xampp\htdocs\heald-clinic\resources\views/patient/layouts/patient.blade.php ENDPATH**/ ?>