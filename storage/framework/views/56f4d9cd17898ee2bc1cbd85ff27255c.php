...
<head>
    ...
    <title>MediEase - Admin Panel <?php echo $__env->yieldContent('title'); ?></title>
...
<a href="<?php echo e(route('admin.clinics.index')); ?>" class="<?php echo e(request()->routeIs('admin.clinics*') ? 'active' : ''); ?>">
...
<script>
    ...
    function loadNotifications() {
        fetch('<?php echo e(route("admin.notifications.index")); ?>', {
...
</html><?php /**PATH C:\xampp\htdocs\heald-clinic\resources\views/layouts/admin.blade.php ENDPATH**/ ?>