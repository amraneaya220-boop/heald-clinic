...
<script>
    ...
    async function fetchStats() {
        try {
            const response = await fetch('<?php echo e(route("clinic.statistics.stats")); ?>');
...
<?php echo $__env->make('clinic.layouts.clinic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\heald-clinic\resources\views/clinic/statistics/index.blade.php ENDPATH**/ ?>