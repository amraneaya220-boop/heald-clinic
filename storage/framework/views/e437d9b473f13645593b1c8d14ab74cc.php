...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MediEase'); ?></title>
...
<div id="sidebar" class="sidebar">
    ...
    <a href="<?php echo e(route('home')); ?>#about"><i class="fas fa-info-circle"></i> <span id="aboutLink">About</span></a>
    <a href="<?php echo e(route('home')); ?>#contact"><i class="fas fa-envelope"></i> <span id="contactLink">Contact</span></a>
...
<div class="navbar">
    ...
    <div class="nav-center">
        <div class="nav-item"><a href="<?php echo e(route('home')); ?>" id="homeLink">Home</a></div>
        <div class="nav-item">
            ...
            <div class="dropdown-content" id="clinicsDropdown">
                ...
                <div id="clinicsList" class="dropdown-items">
                    <?php if(isset($clinics) && count($clinics)): ?>
                        <?php $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('clinic.show', $clinic->id)); ?>">
                                <i class="fas fa-hospital"></i>
                                <div style="flex:1"><strong><?php echo e($clinic->name); ?></strong><br><small><?php echo e($clinic->location); ?></small></div>
                            </a>
        ...
        <div class="nav-item">
            ...
            <div class="dropdown-content" id="doctorsDropdown">
                ...
                <div id="doctorsList" class="dropdown-items">
                    <?php if(isset($doctors) && count($doctors)): ?>
                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('doctor.show', $doctor->id)); ?>">
                                <i class="fas fa-user-md"></i>
                                <div style="flex:1"><strong><?php echo e($doctor->name); ?></strong><br><small><?php echo e($doctor->specialty); ?> - <?php echo e($doctor->clinic->name ?? ''); ?></small></div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
    ...
    <div class="nav-right">
        ...
        <div class="auth-dropdown">
            ...
            <div class="auth-dropdown-content" id="loginDropdown">
                <a href="<?php echo e(route('login', ['type'=>'clinic'])); ?>"><i class="fas fa-hospital"></i> Clinic Login</a>
                <a href="<?php echo e(route('login', ['type'=>'doctor'])); ?>"><i class="fas fa-user-md"></i> Doctor Login</a>
                <a href="<?php echo e(route('login', ['type'=>'patient'])); ?>"><i class="fas fa-user"></i> Patient Login</a>
            </div>
        </div>
        <div class="auth-dropdown">
            ...
            <div class="auth-dropdown-content" id="registerDropdown">
                <a href="<?php echo e(route('register', ['type'=>'clinic'])); ?>"><i class="fas fa-hospital"></i> Clinic Register</a>
                <a href="<?php echo e(route('register', ['type'=>'doctor'])); ?>"><i class="fas fa-user-md"></i> Doctor Register</a>
                <a href="<?php echo e(route('register', ['type'=>'patient'])); ?>"><i class="fas fa-user"></i> Patient Register</a>
            </div>
        </div>
    </div>
</div>
...
</html><?php /**PATH C:\xampp\htdocs\heald-clinic\resources\views/layouts/front.blade.php ENDPATH**/ ?>